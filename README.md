...
| <a name="input_fabric_connection_credentials_variable_set_name"></a> [fabric\_connection\_credentials\_variable\_set\_name](#input\_fabric\_connection\_credentials\_variable\_set\_name) | The name of the variable set used to set credentials for Fabric Connections by Data Platform Engineers. | `string` | `"Fabric Connection Credentials"` | no |

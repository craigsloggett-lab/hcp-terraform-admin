...
| [tfe_variable.github_personal_access_token](https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/resources/variable) | resource |
...
| [tfe_github_app_installation.this](https://registry.terraform.io/providers/hashicorp/tfe/0.71.0/docs/data-sources/github_app_installation) | data source |
...
| <a name="input_github_personal_access_token"></a> [github\_personal\_access\_token](#input\_github\_personal\_access\_token) | A personal access token for the GitHub service account used to configure the VCS provider. | `string` | n/a | yes |
